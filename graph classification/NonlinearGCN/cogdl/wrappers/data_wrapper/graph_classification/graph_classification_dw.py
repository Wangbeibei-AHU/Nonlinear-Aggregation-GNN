...
class GraphClassificationDataWrapper(DataWrapper):
    ...
    def __init__(self, dataset, degree_node_features=False, batch_size=32, train_ratio=0.5, test_ratio=0.3, kfold=0):
        ...
        self.split_idx = None
        self.kfold = kfold
        print('GraphClassificationDataWrapper: kfold = ', self.kfold)
    ...
    def setup_node_features(self):
        ...
        train_idx, val_idx, test_idx = split_dataset(len(self.dataset), self.train_ratio, self.test_ratio, self.kfold)
