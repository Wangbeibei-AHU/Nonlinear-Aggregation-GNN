...
class Trainer(object):
    ...
    def run(self, model_w: ModelWrapper, dataset_w: DataWrapper):
        ...
        # for name in model_w.named_parameters():
        #     print(name)
        #pdb.set_trace()        
        ...
        return final_test, self.recode_val_acc, self.recode_val_loss
        ...
        for stage in range(self.nstage):
            ...
            for epoch in epoch_iter:
                ...
                if val_loader is not None and epoch % self.eval_step == 0:
                    ...
                    self.recode_val_loss.append(val_result['val_loss'].item())
                    self.recode_val_acc.append(val_result['val_metric'].item())
